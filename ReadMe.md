...
- Software developer focused on **Python**, **TypeScript**, and full-stack web development
- Building **Auto-Apply-AI**, an autonomous AI agent for job search & applications (resume tailoring, cover letters, auto-apply)
- Interested in **API design**, **AI agent workflows**, and developer tooling
